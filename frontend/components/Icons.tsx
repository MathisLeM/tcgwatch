...
/**
 * Jeu d'icônes partagé (trait 24×24, style Lucide) repris tel quel des maquettes
 * « Landing v2 » et « Dashboard v2 ». Inline plutôt qu'une dépendance : une
 * vingtaine de tracés, rendus côté serveur quand le composant appelant le permet.
 */
const PATHS = {
  cards: (
    <>
